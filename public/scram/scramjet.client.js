  ...
  var e = {
      ...
      2712: function (e, t, r) {
        ...
        class g {
                  ...
                  {},
                  {
                    get: (e, t) => {
                      ...
                      let r = t.split("."),
                        ...
                        n = r.reduce((e, t) => e?.[t], this.global)
                      if (!n) return
                      let a = (0, c.nativeGetOwnPropertyDescriptor)(n, o)
                      return (e[t] = a), e[t]
                    },
                  },
                ),
          ...
          get frame() {
            ...
            if (!t) {
              ...
              for (; e.parent !== e; ) {
                ...
                if (e.frameElement && e.frameElement[n.D1])
                  return e.frameElement[n.D1]
                e = e.parent.window
              }
            }
            return t
          ...
          get url() {
            return new URL((0, p.Sd)(this.global.location.href))
          }
          set url(e) {
            ...
            this.frame && this.frame.dispatchEvent(t),
              t.defaultPrevented ||
                (this.global.location.href = (0, p.dm)(t.url, this.meta))
          }
          Proxy(e, t) {
            if (Array.isArray(e)) {
                ...
                (n.apply = function (e, t, o) {
                  ...
                  Error.prepareStackTrace = function (e, t) {
                    if (
                      ...
                      !t[0]
                        .getFileName()
                        .startsWith(location.origin + p.vc.prefix)
                    )
          ...
          RawTrap(e, t, r) {
            if (!e || !t || !Reflect.has(e, t)) return
            let o = (0, c.nativeGetOwnPropertyDescriptor)(e, t),
              n = {
                this: null,
                get: function () {
        ...
        function n(e) {
          e.Proxy("CSSStyleDeclaration.prototype.setProperty", {
            ...
            e.Proxy("CSSStyleSheet.prototype.insertRule", {
              apply(t) {
                t.args[0] = (0, o.U5)(t.args[0], e.meta)
              },
            }),
            ...
            e.Proxy(["CSSStyleValue.parse", "CSSStyleValue.parseAll"], {
              apply(t) {
                t.args[1] && (t.args[1] = (0, o.U5)(t.args[1], e.meta))
              },
            }),
      ...
      2439: function (e, t, r) {
        ...
        function l(e, t) {
          let r = {
              ...
              href: [t.HTMLAnchorElement, t.HTMLLinkElement, t.SVGImageElement],
          ...
          e.Trap("Node.prototype.baseURI", {
            ...
            e.Trap(
              ["Element.prototype.innerHTML", "Node.prototype.textContent"],
              {
                set(r, o) {
                  let n
            ...
            e.Trap(
              ...
              ],
              {
                get(e) {
                  let t = e.get()
                  if (!t) return t
                  if (o.a3 in t) return t[o.a3].globalProxy
                  {
                    let e = new n.ScramjetClient(t)
            ...
            e.Trap(
              ...
              ],
              {
                get(t) {
                  ...
                  if (!r) return r
                  if (o.a3 in r) return r[o.a3].documentProxy
                  {
        ...
        function s(e) {
          e.Proxy("window.open", {
            apply(t) {
              ...
              if (a.a3 in r) return t.return(r[a.a3].globalProxy)
              {
                let e = new n.ScramjetClient(r)
            ...
            e.Trap("opener", {
              get(e) {
                let t = e.get()
                return t && a.a3 in t ? t[a.a3].globalProxy : void 0
              },
            }),
            e.Trap("window.frameElement", {
              get(e) {
                let t = e.get()
                return t ? (t.ownerDocument.defaultView[a.a3] ? t : null) : t
              },
            })
        }
      },
      ...
      6101: function (e, t, r) {
        ...
        function n(e, t) {
          e.Proxy("Navigator.prototype.registerProtocolHandler", {
            apply(t) {
              t.args[1] = (0, o.dm)(t.args[1], e.meta)
            },
          }),
          ...
          return new Proxy(t, {
            get(t, r) {
              ...
              if (
                ...
                let e = s.self
                if (e)
                  if (n.a3 in e) return e[n.a3].globalProxy
                  else {
              ...
              if ("$scramjet" !== r)
                return "string" == typeof r && i.includes(r)
                  ? e.wrapfn(s, !0)
                  : s
            },
            set(t, r, o) {
      ...
      8971: function (e, t, r) {
        ...
        function i(e, t) {
          ...
          for (let r of [
            ...
            let n = (0, o.nativeGetOwnPropertyDescriptor)(l, r)
            if (!n) continue
      ...
      5146: function (e, t, r) {
        ...
        var o = r(8810)
        let n = (e) => (0, o.Sp)("captureErrors", e.url)
        function a(e, t = []) {
          switch (typeof e) {
            case "string":
              break
      ...
      7651: function (e, t, r) {
        ...
        var o = r(8810),
          n = r(4471)
        let a = (e) => (0, o.Sp)("cleanErrors", e.url)
        function s(e, t) {
          let r = (e, t) => {
            let r = e.stack
            for (let e = 0; e < t.length; e++) {
              let o = t[e].getFileName()
      ...
      4423: function (e, t, r) {
		...
		`)))
                : (r = this.global.eval),
              r((0, o.Zs)(t, "(indirect eval proxy)", this.meta)))
        }
      },
      8231: function (e, t, r) {
        ...
        var o = r(6707),
          ...
          i = r(3498),
          l = r(2370)
        let c = Symbol.for("scramjet original onevent function")
        function p(e, t) {
          let r = {
            message: {
              _init() {
            ...
            hashchange: {
              oldURL() {
                return (0, n.Sd)(this.oldURL)
              },
              newURL() {
                return (0, n.Sd)(this.newURL)
              },
            },
            storage: {
              _init() {
          ...
          e.Proxy("EventTarget.prototype.addEventListener", {
            apply(t) {
              if (((0, l.unproxy)(t, e), "function" != typeof t.args[1])) return
              let r = t.args[1],
                o = p(r)
              t.args[1] = o
            ...
            e.Proxy("EventTarget.prototype.removeEventListener", {
              apply(t) {
                if (((0, l.unproxy)(t, e), "function" != typeof t.args[1]))
                  return
          ...
          for (let n of (o.iswindow && u.push(t.HTMLElement.prototype),
          t.Worker && u.push(t.Worker.prototype),
          u))
            for (let t of Reflect.ownKeys(n))
              if ("string" == typeof t && t.startsWith("on") && r[t.slice(2)]) {
                let r = (0, i.nativeGetOwnPropertyDescriptor)(n, t)
                if (!r.get || !r.set || !r.configurable) continue
                e.RawTrap(n, t, {
                  get(e) {
                    return this[c] ? this[c] : e.get()
                  },
                  set(e, t) {
                    if (((this[c] = t), "function" != typeof t)) return e.set(t)
                    e.set(p(t))
                  },
                })
              }
      ...
      7636: function (e, t, r) {
        ...
        function n(e, t) {
          let r = e.call().toString(),
            n = (0, o.Zs)(r, "(function proxy)", t.meta)
          e.return(e.fn(`return ${n}`)())
        }
        function a(e, t) {
          e.Proxy("Function", {
            apply(t) {
      ...
      4636: function (e, t, r) {
        ...
        function a(e, t) {
          ...
          ;(t[o.vc.globals.importfn] = function (t, o) {
            let a = new URL(o, t).href
            return r(`return import("${(0, n.dm)(a, e.meta)}")`)()
          }),
      ...
      6594: function (e, t, r) {
        ...
        var o = r(4471)
        let n = Symbol.for("scramjet realm pollutant")
        function a(e, t) {
            ...
            e.Proxy("WebSocketStream", {
              construct(r) {
                let n,
                  ...
                  s,
                  i = {}
                Object.setPrototypeOf(i, r.fn.prototype), (i.constructor = r.fn)
            ...
            e.Proxy("XMLHttpRequest.prototype.send", {
              apply(t) {
                ...
                let p = l.getUint16(1),
                  u = l.getUint32(3),
                  f = new Uint8Array(u)
                f.set(new Uint8Array(i.slice(7, 7 + u)))
                let g = new TextDecoder().decode(f),
                  d = l.getUint32(7 + u),
                  y = new Uint8Array(d)
                y.set(new Uint8Array(i.slice(11 + u, 11 + u + d)))
                let m = new TextDecoder().decode(y)
                e.RawTrap(t.this, "status", { get: () => p }),
      ...
      6321: function (e, t, r) {
        r.r(t), r.d(t, { default: () => i, enabled: () => s })
        var o = r(8810),
          n = r(9777)
        let a = "/*scramtag ",
          s = (e) => (0, o.Sp)("sourcemaps", e.url)
        function i(e, t) {
              ...
              value: (e, t) => {
                ...
                !(function (e, t) {
                  ...
                  for (let e = 0; e < i; e++) {
                    ...
                    l += 4
                    let t = o.getUint32(l, !0)
                    l += 4
                    let n = o.getUint8(l)
                    if (((l += 1), 0 == n))
                      s.push({ type: n, start: e, size: t })
                    else if (1 == n) {
                      let i = e + t,
                        c = o.getUint32(l, !0)
                      l += 4
                      let p = a.decode(r.subarray(l, l + c))
                      s.push({ type: n, start: e, end: i, str: p })
                    }
                  }
                  self[n.a3].sourcemaps[t] = s
                })(e, t)
                let a = performance.now() - r
                if ((0, o.Sp)("rewriterLogs", new URL(location.href))) {
                  let e
                  ;(e =
                    a < 1
                      ? "BLAZINGLY FAST"
                      : a < 500
                        ...
                        : "really slow"),
                    console.log(
                      `js rewrite parsing for scramtag ${t} was ${e} (${a.toFixed(2)}ms)`,
                    )
                }
              },
              enumerable: !1,
              ...
              apply(e) {
                ...
                !(function (e) {
                  let t = e.fn.call(e.this),
                    r = t.indexOf("/*s")
                  if (-1 === r) return e.return(t)
                  let o = t.indexOf(" ", r + a.length),
                    s = parseInt(t.substring(r + a.length, o)) - r,
                    i = s + t.length,
                    l = t.indexOf("*/", r),
                    c = t.substring(o + 1, l),
                    p = (function (e) {
                      function t(r) {
                        let o = r.Symbol.for(n.i9)
                        if (r[o] && r[o].sourcemaps && r[o].sourcemaps[e])
                          return r[o].sourcemaps[e]
                        for (let e = 0; e < r.frames.length; e++) {
                          let o = t(r.frames[e].self)
                          if (o) return o
                        }
                      }
                      let r = self,
                  ...
                  if (!p)
                    return (
                      console.warn("failed to get rewrites for tag", c),
                      e.return(t)
                    )
                  let u = 0
                  for (; u < p.length; )
                  ...
                  let g = p.slice(u, f),
                    ...
                    y = s
                  for (let e of g)
                    if (((d += t.slice(y, e.start)), 0 === e.type))
                      y = e.start + e.size
                    else if (1 === e.type) (d += e.str), (y = e.end)
                    else throw "unreachable"
                  ;(d += t.slice(y)), e.return(d)
                })(e)
                  ...
                  ;(e =
                    r < 1
                      ...
                      : r < 500
                        ...
                        : "really slow"),
                    console.log(
                      `js unrewrite for function was ${e} (${r.toFixed(2)}ms)`,
                    )
                }
              },
            })
      ...
      2370: function (e, t, r) {
        ...
        function s(e, t) {
          let r = t.global
          for (let o in (e.this === t.globalProxy && (e.this = r),
      ...
      7706: function (e, t, r) {
        ...
        function i(e, t) {
          return function (r, a) {
            ...
            if (r === eval) return s.indirectEval.bind(e, a)
            if (o.iswindow) {
              if (r === t.parent)
                if (n.a3 in t.parent) return t.parent[n.a3].globalProxy
                else return e.globalProxy
              else if (r === t.document) return e.documentProxy
              else if (r === t.top) {
                let e = t
                for (;;) {
                  let t = e.parent.self
                  if (t === e || !(n.a3 in t)) break
                  e = t
                }
                return e[n.a3].globalProxy
              }
            }
            return r
          }
      ...
      5425: function (e, t, r) {
        ...
        function n(e, t) {
          e.Proxy("importScripts", {
            apply(t) {
              for (let r in t.args) t.args[r] = (0, o.dm)(t.args[r], e.meta)
            },
          })
        }
      },
	...
	`,
      ...
      8810: function (e, t, r) {
        ...
        function s(e, t) {
          let r = o.config.flags[e]
          for (let r in o.config.siteFlags) {
            let n = o.config.siteFlags[r]
      ...
      4079: function (e, t, r) {
        ...
        function s(e, t, r, i = !1) {
          return (function (e, t, r, s = !1) {
            if ((0, o.Sp)("naiiveRewriter", r.origin)) {
              var i
              return {
                js:
                  ("string" !=
	...
	`),
            ...
            return (function (e, t, r, s) {
              ...
              try {
                ...
                try {
                  n =
                    "string" == typeof e
                      ? i.rewrite_js(e, r.base.href, t || "(unknown)", s)
                      : i.rewrite_js_bytes(e, r.base.href, t || "(unknown)", s)
                } catch (r) {
                  return (
                    console.warn("failed rewriting js for", t, r.message, e),
                    { js: e, tag: "", map: null }
                  )
                }
                let c = performance.now(),
                  { js: p, map: u, scramtag: f, errors: g } = n,
                  d = c - l
                if (
                  ((0, o.Sp)("sourcemaps", r.base) &&
                    !globalThis.clients &&
                    (globalThis[
                      globalThis.$scramjet.config.globals.pushsourcemapfn
                    ](Array.from(u), f),
                    (u = null)),
                  (0, o.Sp)("rewriterLogs", r.base))
                )
                  for (let e of g) console.error("oxc parse error", e)
                ;(0, o.Sp)("rewriterLogs", r.base) &&
                  console.log(
                    `oxc rewrite for "${t || "(unknown)"}" was ${d < 1 ? "BLAZINGLY FAST" : d < 500 ? "decent speed" : "really slow"} (${d}ms)`,
                  )
                return {
                  js: "string" == typeof e ? a.decode(p) : p,
                  tag: f,
                  map: u,
                }
              } finally {
      ...
      2434: function (e, t, r) {
        ...
        function s(e, t) {
          if (
            ...
            return "javascript:" + (0, n.Z)(e.slice(11), "(javascript: url)", t)
          {
            if (e.startsWith("blob:") || e.startsWith("data:"))
              return location.origin + o.h3.config.prefix + e
            if (e.startsWith("mailto:") || e.startsWith("about:")) return e
            let r = t.base.href
            r.startsWith("about:") &&
              (r = (function (e) {
                e instanceof URL && (e = e.toString())
                let t = location.origin + o.h3.config.prefix
                if (e.startsWith("javascript:")) return e
                {
                  ...
                  let r = a(e)
                  if (!r) return e
                  let n = o.h3.codec.decode(r.hash.slice(1))
                  return (
                    (r.hash = ""),
                    o.h3.codec.decode(
                      r.href.slice(t.length) + (n ? "#" + n : ""),
                    )
                  )
                }
              })(self.location.href))
            let n = a(e, r)
            if (!n) return e
            let s = o.h3.codec.encode(n.hash.slice(1))
            return (
              (n.hash = ""),
              location.origin +
                o.h3.config.prefix +
                o.h3.codec.encode(n.href) +
                (s ? "#" + s : "")
            )
          }
        }
      ...
      522: function (e, t, r) {
        ...
        let a = new TextDecoder(),
          s = "\0asm".split("").map((e) => e.charCodeAt(0))
        function i(e) {
          let t
          if (!(self.REAL_WASM && self.REAL_WASM instanceof Uint8Array))
            throw Error("rewriter wasm not found (was it fetched correctly?)")
          if (![...self.REAL_WASM.slice(0, 4)].every((e, t) => e === s[t]))
            throw Error(
              "rewriter wasm does not have wasm magic (was it fetched correctly?)\nrewriter wasm contents: " +
                a.decode(self.REAL_WASM),
            )
          ;(0, o.rb)({ module: new WebAssembly.Module(self.REAL_WASM) }),
            n.h3.shared.rewriter || (n.h3.shared.rewriter = [])
          let r = n.h3.shared.rewriter.findIndex((e) => !e.inUse),
            i = n.h3.shared.rewriter.length
          return (
            -1 === r
              ? ((0, n.Sp)("rewriterLogs", e.base) &&
                  console.log(
                    `creating new rewriter, ${i} rewriters made already`,
                  ),
                (t = { rewriter: new o.mZ(n.h3), inUse: !0 }),
                n.h3.shared.rewriter.push(t))
              : ((0, n.Sp)("rewriterLogs", e.base) &&
                  console.log(
                    `using cached rewriter ${r} from list of ${i} rewriters`,
                  ),
                (t = n.h3.shared.rewriter[r])),
            [t.rewriter, () => (t.inUse = !1)]
          )
        }
      },
      9777: function (e, t, r) {
        r.d(t, { D1: () => a, a3: () => n, i9: () => o })
        let o = "scramjet client global",
          n = Symbol.for(o),
          a = Symbol.for("scramjet frame handle")
      },
      3093: function (e, t, r) {
        r.d(t, { t: () => o })
        function o() {
      ...
      7418: function (e, t, r) {
        ...
        function l() {
          return (
            (null === i || 0 === i.byteLength) &&
              (i = new Uint8Array(o.memory.buffer)),
            i
          )
        }
        function c(e, t) {
          return (e >>>= 0), s.decode(l().subarray(e, e + t))
        }
        let p = 0,
          u =
        ...
        function y() {
          return (
            (null === d ||
              !0 === d.buffer.detached ||
              (void 0 === d.buffer.detached && d.buffer !== o.memory.buffer)) &&
              (d = new DataView(o.memory.buffer)),
            d
          )
        }
        function m(e) {
          let t = o.__wbindgen_export_2.get(e)
          return o.__externref_table_dealloc(e), t
        }
        let h =
          "undefined" == typeof FinalizationRegistry
            ? { register: () => {}, unregister: () => {} }
            : new FinalizationRegistry((e) => o.__wbg_rewriter_free(e >>> 0, 1))
        class b {
          __destroy_into_raw() {
          ...
          free() {
            ...
            o.__wbg_rewriter_free(e, 0)
          }
          constructor(e) {
            let t = o.rewriter_new(e)
            if (t[2]) throw m(t[1])
            return (
          ...
          rewrite_js(e, t, r, n) {
            let a = g(e, o.__wbindgen_malloc, o.__wbindgen_realloc),
              s = p,
              i = g(t, o.__wbindgen_malloc, o.__wbindgen_realloc),
              l = p,
              c = g(r, o.__wbindgen_malloc, o.__wbindgen_realloc),
              u = p,
              f = o.rewriter_rewrite_js(this.__wbg_ptr, a, s, i, l, c, u, n)
            if (f[2]) throw m(f[1])
            return m(f[0])
          }
          rewrite_js_bytes(e, t, r, n) {
            let a = (function (e, t) {
                ...
                return l().set(e, r / 1), (p = e.length), r
              })(e, o.__wbindgen_malloc),
              s = p,
              i = g(t, o.__wbindgen_malloc, o.__wbindgen_realloc),
              c = p,
              u = g(r, o.__wbindgen_malloc, o.__wbindgen_realloc),
              f = p,
              d = o.rewriter_rewrite_js_bytes(
                this.__wbg_ptr,
                a,
                s,
                i,
        ...
        function v() {
          ...
          return (
            ...
            (e.wbg.__wbg_scramtag_3a255d78b157986d = function (e) {
              let t = g((0, n.t)(), o.__wbindgen_malloc, o.__wbindgen_realloc),
                r = p
            ...
            (e.wbg.__wbindgen_string_get = function (e, t) {
              ...
              var n =
                  null == r
                    ? 0
                    : g(r, o.__wbindgen_malloc, o.__wbindgen_realloc),
                a = p
              y().setInt32(e + 4, a, !0), y().setInt32(e + 0, n, !0)
            }),
        ...
        async function P(e) {
          ...
          ;("string" == typeof e ||
            ...
            (e = fetch(e))
          let { instance: r, module: n } = await w(await e, t)
          return x(r, n)
        }
      },
    },
